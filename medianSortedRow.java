...
public class MedianInRowSorted 
{
	...
	static int binaryMedian(int m[][],int r, int c, int desired)
	{
	...
	public static int findMedian(int[][] m) {
	    ...
	    if ((r * c) % 2 == 1) {
	        return binaryMedian(m, r, c, (r * c + 1)/ 2);
	    } else {
	        return (binaryMedian(m, r, c, (r * c + 1)/2) + binaryMedian(m, r, c, r * c / 2)) / 2;
	    }
	}
	public static void main(String[] args) 
	{
		int m[][]= { {1,3,5,6}, {2,6,9,10}, {3,6,9,10} };
